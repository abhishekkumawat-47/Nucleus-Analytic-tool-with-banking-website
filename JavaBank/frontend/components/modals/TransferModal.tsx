      ...
      <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto w-[95vw] rounded-2xl">
        ...
        <div className="space-y-5 py-2">
          ...
          <div className="space-y-2">
            ...
            <Select value={fromAccount} onValueChange={setFromAccount}>
              <SelectTrigger className="w-full h-12 rounded-xl border-gray-200 focus:border-green-400 focus:ring-green-400">
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <IndianRupee className="absolute left-3 top-3.5 h-4 w-4 text-green-400" />
              <Input
                type="number"
                placeholder="0.00"
                value={amount}
                onChange={(e) => setAmount(e.target.value)}
                className="pl-9 h-12 rounded-xl border-gray-200 focus:border-green-400 text-lg font-semibold"
                min="1"
              />
            </div>
        ...
        <DialogFooter className="gap-3 sm:gap-0">
          ...
          <Button
            ...
            className="rounded-xl bg-green-600 hover:bg-green-700 text-white min-w-[130px]"
          >
            {loading ? (
              <>
