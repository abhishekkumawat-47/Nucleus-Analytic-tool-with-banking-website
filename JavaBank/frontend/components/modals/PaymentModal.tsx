      ...
      <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto w-[95vw] rounded-2xl">
        ...
        <div className="space-y-5 py-2">
          ...
          <div className="space-y-2">
            ...
            <Select value={fromAccount} onValueChange={setFromAccount}>
              <SelectTrigger className="w-full h-12 rounded-xl border-gray-200 focus:border-green-400">
        ...
        <DialogFooter className="gap-3 sm:gap-0">
          ...
          <Button
            ...
            className="rounded-xl bg-green-600 hover:bg-green-700 text-white min-w-[120px]"
          >
            {loading ? (
              <>
