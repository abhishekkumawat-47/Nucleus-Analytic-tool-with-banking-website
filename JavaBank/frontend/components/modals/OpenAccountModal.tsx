...
const OpenAccountModal = ({ isOpen, onClose, userId, onSuccess }: OpenAccountModalProps) => {
  ...
  const [ifsc, setIfsc] = useState('JAVA0001');
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="e.g. JAVA0001 / OMAX0001"
        ...
        <DialogFooter className="flex gap-2 sm:justify-end flex-col sm:flex-row">
          ...
          <Button onClick={handleCreateAccount} disabled={isLoading} className="bg-green-600 hover:bg-green-700 rounded-lg shadow-md w-full sm:w-auto">
