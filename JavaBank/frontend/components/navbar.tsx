      ...
      <div className="container mx-auto px-4 md:px-6 flex h-16 items-center justify-between">
        <div className="flex items-center gap-2 md:gap-4">
                    ...
                    <div className="flex items-center gap-2">
                      <SheetHeader><SheetTitle>
                        <div className="flex justify-center items-center gap-2">
                          ...
                          <span className="font-bold text-xl">JavaBank</span>
                        </div>
          ...
          <Link href={isHomePage ? "/" : "/dashboard"} className="flex items-center gap-2">
            <Image src="/logo.png" alt="Logo" width={36} height={36} className="rounded-full" />
            <span className={`font-bold text-xl tracking-tight ${isHomePage ? "text-white" : "text-zinc-900"}`}>JavaBank</span>
          </Link>
            ...
            <>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="icon" className="rounded-full overflow-hidden border border-green-200" aria-label="User menu">
                    <Avatar className="h-8 w-8 hover:scale-110 transition-transform">
                      <AvatarImage src="/user.png" alt="User Profile" />
                      <AvatarFallback className="bg-green-100 text-green-700 font-bold">AK</AvatarFallback>
                    </Avatar>
                  </Button>
                </DropdownMenuTrigger>
                <DropdownMenuContent align="end">
                  ...
                  {role === "ADMIN" && (
                    <>
                      ...
                      <DropdownMenuItem asChild>
                        <a href={`${analyticsDashboardBase}/javabank/dashboard`} target="_blank" rel="noopener noreferrer" className="cursor-pointer">
                  ...
                  <DropdownMenuSeparator />
                  <DropdownMenuItem className="cursor-pointer text-red-600 focus:text-rose-700 focus:bg-rose-50" onClick={handleLogout}>
                    Sign out
                  </DropdownMenuItem>
                </DropdownMenuContent>
              </DropdownMenu>
