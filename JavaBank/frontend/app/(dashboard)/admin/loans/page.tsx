            ...
            {app.status === "PENDING" && (
              <>
                ...
                <Button 
                  variant="ghost" 
                  size="sm" 
                  className="rounded-full h-9 w-9 p-0 bg-rose-50 text-red-600 hover:bg-rose-500 hover:text-white transition-all cursor-pointer border border-rose-100"
                  onClick={() => {
      ...
      <div className="p-8 max-w-7xl mx-auto space-y-8 animate-fade-in">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground font-medium mt-1 uppercase text-[10px] tracking-widest text-green-600">Review and process system-wide loan applications.</p>
          </div>
              ...
              <div className="flex flex-col">
                <div className="bg-zinc-900 p-8 text-white">
                   <div className="flex justify-between items-start">
                      <div>
                        <Badge className="bg-green-500 hover:bg-green-500 text-white font-bold mb-4 rounded-full px-3 py-1 text-[10px] uppercase tracking-widest">
                           Application Review
                        </Badge>
                      ...
                      <div className="p-4 bg-green-500 rounded-3xl border border-white/10 text-right">
                ...
                {selectedApp.status === "PENDING" && (
                  <DialogFooter className="p-8 bg-white border-t border-zinc-100 gap-4 sm:justify-between items-center">
                    <Button 
                      variant="outline" 
                      className="w-full sm:w-auto h-14 rounded-2xl font-black text-red-600 hover:bg-rose-50 hover:text-rose-700 border-none cursor-pointer"
                    ...
                    <Button 
                      className="w-full sm:w-auto h-14 px-10 rounded-2xl bg-zinc-900 hover:bg-green-600 text-white font-black shadow-xl shadow-zinc-200 transition-all cursor-pointer"
