...
export default function AdminSimulatePage() {
  ...
  return (
    <AdminGuard>
         <div className="p-6 md:p-8 max-w-6xl mx-auto space-y-8 animate-fade-in bg-gradient-to-b from-white via-white to-green-50/30 min-h-screen">
        <div className="flex justify-between items-start">
           <div>
                ...
                <div className="bg-white border border-green-200 px-6 py-4 rounded-3xl flex items-center gap-4 shadow-sm">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
           <div className="lg:col-span-1 space-y-6">
              <Card className="rounded-[2rem] border-green-100 shadow-xl shadow-green-100/30 bg-white">
                 <CardHeader>
                 ...
                 <CardContent className="space-y-6">
                    ...
                    <Button 
                      className="w-full h-14 rounded-2xl bg-black hover:bg-green-700 text-white font-black shadow-lg shadow-green-200 transition-all cursor-pointer"
              ...
              <div className="bg-white border border-green-100 p-8 rounded-[2rem] space-y-4 shadow-sm">
                 ...
                 <ul className="space-y-3">
                    {[
                      ...
                      <li key={i} className="flex gap-2 text-xs font-medium text-zinc-600">
                         <div className="h-1.5 w-1.5 rounded-full bg-green-400 mt-1 opacity-50" />
                         {step}
                      </li>
                    ))}
                 </ul>
           ...
           <div className="lg:col-span-2 space-y-6">
              {!result && !loading && (
                         <div className="h-full min-h-[420px] border-2 border-dashed border-green-200 rounded-[2rem] flex flex-col items-center justify-center text-center p-12 bg-white">
              ...
              {loading && (
                         <div className="h-full min-h-[420px] bg-white border border-green-200 rounded-[2rem] p-8 shadow-sm space-y-6">
                              ...
                              <div className="rounded-2xl border border-green-100 bg-green-50/40 p-5 space-y-3">
              ...
              {result && (
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                  {computedStats.map((stat) => (
                                     <div key={stat.label} className="bg-white p-6 rounded-[1.5rem] border border-green-100 shadow-sm flex flex-col items-center text-center">
                                          <stat.icon className="h-6 w-6 text-green-700 mb-3" />
                            ...
                            <span className="text-[10px] font-black text-zinc-400 uppercase tracking-widest mt-1">{stat.label}</span>
                              ...
                              <div className="grid md:grid-cols-2 gap-4">
                                  <div className="bg-white p-6 rounded-2xl border border-green-100">
                                     <h3 className="text-base font-black text-zinc-900 flex items-center gap-2"><Rocket className="h-4 w-4 text-green-700" /> Processing Details</h3>
                                  ...
                                  <div className="bg-black p-6 rounded-2xl text-white">
                                     <h3 className="text-base font-black tracking-tight flex items-center gap-2"><Server className="h-4 w-4 text-green-300" /> Analytics Propagation</h3>
                                     <p className="text-green-100 text-sm mt-3 leading-relaxed">
                                        ...
                                        <a
                                           href={`${analyticsDashboardBase}/javabank/dashboard`}
                                           target="_blank"
                                           rel="noopener noreferrer"
                                           className="mt-4 inline-flex items-center rounded-xl bg-white px-3 py-2 text-xs font-black uppercase tracking-wider text-black hover:bg-green-100"
                                        >
                                           Open Javabank Analytics
                                        </a>
                          ...
                          <div>
                                           <h3 className="text-xl font-black tracking-tight text-zinc-900 flex items-center gap-2"><BarChart3 className="h-5 w-5 text-green-700" /> Records Live</h3>
                                           ...
                                           <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3 text-xs">
                                              ...
                                              <div className="rounded-xl bg-green-50 border border-green-100 p-3">
                                                 ...
                                                 <p className="text-xl font-black text-zinc-900 flex items-center gap-1"><Clock3 className="h-4 w-4 text-green-700" /> {((result.runMs || 0) / 1000).toFixed(2)}s</p>
                                              </div>
                                           </div>
                          </div>
                       </div>
