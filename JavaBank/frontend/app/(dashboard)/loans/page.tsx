      ...
      <main className="flex-grow">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h1 className="text-4xl md:text-4xl lg:text-5xl font-extrabold mb-6 tracking-tight text-zinc-900 leading-[1.1]">
                ...
                <span className="text-4xl text-transparent bg-clip-text bg-gradient-to-r from-green-600 to-emerald-600">
                   biggest ambitions
                </span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button size="lg" className="h-14 px-8 rounded-full group bg-green-600 hover:bg-green-700 text-white shadow-xl hover:shadow-green-200/50 transition-all cursor-pointer font-bold text-lg" onClick={() => handleApplyNow()}>
                  Apply for a Loan
            ...
            {/* EMI Calculator */}
            <div className="relative rounded-xl border border-green-100 bg-white/80 backdrop-blur-2xl shadow-2xl p-8 md:p-10 z-10 transition-all hover:shadow-green-100 duration-500 group">
              <div className="absolute top-0 right-0 w-full h-3.5  bg-gradient-to-r from-green-400 to-emerald-500 rounded-t-2xl"></div>
              <h3 className="text-2xl font-bold mb-8 text-zinc-900  flex items-center gap-3">
                <div className="p-2 bg-green-100 rounded-lg"><Calculator className="h-6 w-6 text-green-600" /></div>
                EMI Estimator
              </h3>
                ...
                <div className="space-y-6">
                  <div className="space-y-3">
                    ...
                    <div className="relative">
                      <IndianRupee className="absolute left-4 top-3.5 h-4 w-4 text-green-400" />
                      <Input
                        min="1000"
                        step="5000"
                        id="amount"
                        ...
                        className="pl-12 rounded-2xl bg-gray-100/50 border-gray-100 focus:border-green-500 focus:ring-green-500 h-12 text-lg font-bold"
                      />
                    </div>
                  </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          className="pr-10 rounded-2xl bg-gray-100/50 border-gray-100 focus:border-green-500 font-bold h-12"
                        />
                        <PercentIcon className="absolute right-4 top-3.5 h-4 w-4 text-green-400" />
                      </div>
                    </div>
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <Input
                          ...
                          className="rounded-2xl bg-gray-100/50 border-gray-100 focus:border-green-500 font-bold h-12"
                        />
                        <Clock className="absolute right-4 top-3.5 h-4 w-4 text-green-400" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="p-6 bg-gradient-to-br from-green-600 to-emerald-700 rounded-2xl shadow-lg relative overflow-hidden text-white">
        ...
        <section className="my-20">
          ...
          {fetchingApps ? (
            ...
            <div className="p-20 border-4 border-dashed border-gray-100 rounded-[3rem] text-center bg-gray-100/30">
              ...
              <Button onClick={() => handleApplyNow()} className="mt-6 bg-green-600 hover:bg-green-700 text-white rounded-2xl px-6">
                Apply Now
              </Button>
            </div>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {applications.map((app) => (
                <Card key={app.id} className="rounded-[2.5rem] border-green-100 overflow-hidden shadow-sm hover:shadow-xl transition-all">
                  ...
                  <CardContent className="p-8">
                    ...
                    {app.kycData && Object.keys(app.kycData).length > 0 && (
                      <button
                        className="w-full flex items-center justify-between text-xs text-green-600 font-bold mb-4 hover:text-green-800 transition-colors"
        ...
        <section className="mt-24 mb-16">
          <div className="text-center mb-12">
            <h2 className="text-sm font-black tracking-widest text-green-600 uppercase mb-3">Tailored Solutions</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20 mx-10">
            {loanTypes.map((loan) => (
              <Card key={loan.type} className="border-zinc-100 shadow-sm hover:shadow-xl hover:border-green-200 transition-all duration-300 overflow-hidden">
                <div className="h-2 w-full bg-gradient-to-r from-green-500 to-emerald-500 group-hover:h-3 transition-all" />
                <CardContent className="p-8 pb-10">
                  ...
                  <div className="mt-6 mb-8 p-4 bg-green-50 rounded-2xl border border-green-100/50">
                    <p className="text-[10px] font-black uppercase text-green-600 tracking-widest mb-1">Starting At</p>
                    <p className="text-3xl font-extrabold text-green-700">{loan.interestRate}% <span className="text-sm font-bold opacity-60">APR</span></p>
                  </div>
                  ...
                  <Button 
                    variant="outline" 
                    className="w-full rounded-xl border-2 border-green-100 text-green-700 hover:bg-green-600 hover:text-white hover:border-green-600 transition-colors cursor-pointer font-bold h-12"
        ...
        <section className="py-16 px-4 md:px-12 bg-zinc-900 rounded-[3rem] text-white shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 right-0 w-96 h-96 bg-green-600 blur-[150px] opacity-20" />
          <div className="absolute bottom-0 left-0 w-96 h-96 bg-green-600 blur-[150px] opacity-20" />
          
          <div className="relative z-10 text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-sm font-black tracking-widest text-emerald-400 uppercase mb-3">The JavaBank Advantage</h2>
