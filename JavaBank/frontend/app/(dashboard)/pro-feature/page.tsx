          ...
          <Card className="border-zinc-100 bg-zinc-50/50">
            ...
            <CardContent className="text-sm text-zinc-600 leading-relaxed space-y-4">
              ...
              <div className="p-4 bg-white rounded-xl border border-zinc-100 italic text-zinc-500">
                "JavaBank Pro gave us the transparency we needed for our payroll and wealth tracking. Highly recommended."
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {books.map((b, i) => (
          <Card key={i} className="group hover:border-green-300 hover:shadow-lg transition-all duration-300 cursor-pointer overflow-hidden">
              ...
              <div className={`${b.color} p-5 flex items-center justify-between`}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <h3 className="font-bold text-sm text-zinc-800 leading-tight group-hover:text-green-700 transition-colors">{b.title}</h3>
                  </div>
                </div>
              </div>
              <div className="p-4 space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    variant="outline"
                    size="sm"
                    className="rounded-full gap-1.5 text-xs hover:bg-green-50 hover:text-green-700 hover:border-green-300 transition-all"
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
        {assets.map(a => (
          <Card
            key={a.id}
            className={`cursor-pointer transition-all duration-200 hover:shadow-md ${selectedAsset === a.id ? 'border-2 border-green-500 shadow-lg shadow-green-100' : 'border-zinc-100'}`}
          ...
          >
            <CardContent className="p-4 space-y-1">
              ...
              <p className={`text-xs font-bold ${a.change24h >= 0 ? 'text-emerald-600' : 'text-red-600'}`}>
        ...
        <Card className="lg:col-span-1 border-2 border-zinc-100">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Button onClick={() => handleTrade("SELL")} disabled={trading} className="bg-red-600 hover:bg-rose-700 text-white font-bold h-12 rounded-xl">
                SELL
              </Button>
            </div>
          </CardContent>
                  ...
                  return (
                    <div key={i} className="flex items-center justify-between p-4 bg-zinc-50 rounded-xl border border-zinc-100">
                      ...
                      <div className="text-right">
                        ...
                        <p className={`text-xs font-bold ${pnl >= 0 ? 'text-emerald-600' : 'text-red-600'}`}>
...
function WealthManagementModule() {
  ...
  const CHART_COLORS = ["#14532d", "#166534", "#15803d", "#16a34a", "#22c55e", "#4ade80", "#86efac", "#bbf7d0"]
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        {[
          ...
          { label: "Investments", value: `₹${insights.investmentValue?.toLocaleString('en-IN')}`, icon: TrendingUp, color: "text-green-600", bg: "bg-green-50" },
              ...
              {searchResults.length > 0 && (
                <div className="border border-zinc-100 rounded-xl overflow-hidden divide-y divide-zinc-50">
                  {searchResults.map((r, i) => (
                    <div key={i} className="flex items-center justify-between p-3 hover:bg-green-50 transition-colors">
                      <div>
              ...
              <div className="space-y-2 max-h-[300px] overflow-y-auto">
                {selectedPayees.map((p, i) => (
                  <div key={i} className="flex items-center justify-between p-2.5 bg-zinc-50 rounded-lg border border-zinc-100">
                    <div className="flex items-center gap-2">
                      <div className="h-7 w-7 bg-gradient-to-br from-green-400 to-blue-500 rounded-full flex items-center justify-center text-[10px] text-white font-bold">
                        {p.name[0]}
                      </div>
                      <div>
                        <p className="font-bold text-xs text-zinc-800">{p.name}</p>
                    ...
                    <Button
                      ...
                      className="h-6 w-6 p-0 rounded-full text-rose-400 hover:text-red-600 hover:bg-rose-50"
                    >
                      <X className="h-3 w-3" />
                    </Button>
                  </div>
