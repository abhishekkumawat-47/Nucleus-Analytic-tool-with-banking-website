...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white antialiased">
      {/* Hero Section */}
      <section className="relative min-h-screen flex flex-col justify-center bg-white px-6 md:px-10 overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 left-5 w-72 h-72 bg-green-100/40 rounded-full filter blur-3xl opacity-30"></div>
          <div className="absolute bottom-1/4 right-5 w-96 h-96 bg-emerald-100/40 rounded-full filter blur-3xl opacity-25"></div>
          <div className="absolute top-1/2 left-1/2 w-80 h-80 bg-green-50/30 rounded-full filter blur-3xl opacity-20"></div>
        </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12 md:gap-20">
              ...
              >
                {isAuthLoading ? (
                  <>
                    ...
                    <Skeleton className="h-14 w-32 rounded-full bg-zinc-200" />
                  </>
                ) : isAuth ? (
                  <Button
                    size="lg"
                    asChild
                    className="bg-green-600 hover:bg-green-700 text-white rounded-full shadow-lg shadow-green-200/50 hover:shadow-green-300/50 transition-all cursor-pointer font-bold px-8 h-14"
                  >
                  ...
                  <>
                    <Button
                      size="lg"
                      asChild
                      className="bg-green-600 hover:bg-green-700 text-white rounded-full shadow-lg shadow-green-200/50 hover:shadow-green-300/50 transition-all cursor-pointer h-14"
                    >
                    ...
                    <Button
                      ...
                      variant="outline"
                      asChild
                      className="rounded-full border-green-300 hover:bg-green-50 hover:text-green-700 hover:border-green-400 transition-all cursor-pointer h-14"
                    >
            ...
            >
              <div className="relative">
                ...
                <div className="aspect-[9/16] md:aspect-[4/3] w-full max-w-lg rounded-2xl bg-gradient-to-br from-green-600 to-emerald-700 shadow-2xl relative overflow-hidden border-8 border-white md:ml-auto">
                  <div className="absolute inset-0 opacity-90 bg-[radial-gradient(at_top_right,_var(--tw-gradient-stops))] from-green-900/20 via-green-900/40 to-emerald-900/60"></div>
                      ...
                      <div className="space-y-3">
                        {[
                          ...
                          >
                            ...
                            <p
                              className={`font-medium ${tx.amount.startsWith("+")
                                  ? "text-green-300"
                                  : "text-white"
                                }`}
                            >
                ...
                {/* Card 1: Quick Action */}
                <div className="absolute -bottom-6 -left-6 w-48 h-32 bg-white dark:bg-gray-800 rounded-xl shadow-lg hidden md:block rotate-6 p-4 border border-green-100 dark:border-green-900/20">
                ...
                {/* Card 2: Notification */}
                <div className="absolute -top-4 -right-8 w-48 h-28 bg-white dark:bg-gray-800 rounded-xl shadow-lg hidden md:block -rotate-12 p-4 border border-green-100 dark:border-green-900/20">
      ...
      <section className="py-24 px-6 md:px-10 bg-white relative">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute -top-20 right-0 w-64 h-64 bg-green-50 rounded-full filter blur-3xl opacity-40"></div>
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
          <div className="flex flex-col items-center text-center mb-16">
            <div className="inline-block mb-3 px-4 py-1 bg-emerald-100 text-emerald-700 rounded-full font-medium text-sm">
              Why Choose JavaBank?
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
            {[
              ...
              >
                <div className="mb-5 p-4 rounded-xl bg-green-100">
                  {feature.icon}
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-8">
                JavaBank combines cutting-edge technology with thoughtful
              ...
              <Button
                asChild
                className="mt-10 bg-green-600 hover:bg-green-700 text-white rounded-full shadow-md hover:shadow-lg transition-all"
              >
                <Link href="/register" className="flex items-center">
      ...
      <footer className="bg-gradient-to-b from-gray-900 to-gray-950 text-white py-20 px-6 md:px-10 relative overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-green-500 via-transparent to-green-500 opacity-30"></div>
          <div className="absolute -top-48 -right-48 w-96 h-96 bg-green-900/20 rounded-full filter blur-3xl"></div>
          <div className="absolute -bottom-48 -left-48 w-96 h-96 bg-emerald-900/20 rounded-full filter blur-3xl"></div>
        </div>
        ...
        <div className="container mx-auto max-w-6xl relative z-10">
                    ...
                    <ul className="space-y-3">
                      {column.links.map((link, j) => (
                        <li key={j}>
                          ...
                          >
                            <span className="inline-block w-0 group-hover:w-2 h-[1px] bg-green-400 mr-0 group-hover:mr-2 transition-all duration-300"></span>
                            {link}
                          </Link>
                        </li>
                      ))}
            ...
            <div className="flex gap-6">
              {[
                ...
                <Link
                  key={i}
                  href="#"
                  className="w-10 h-10 rounded-full bg-white/5 hover:bg-green-600/30 border border-white/10 flex items-center justify-center transition-colors group"
                  aria-label={platform.name}
                >
                  <span className="sr-only">{platform.name}</span>
                  <div className="text-gray-400 group-hover:text-green-300 transition-colors">
                    {platform.icon}
                  </div>
                </Link>
              ))}
              ...
              <form className="flex items-center">
                <div className="relative">
                  <input
                    ...
                    className="bg-white/5 border border-white/10 rounded-l-full py-2 pl-4 pr-10 text-sm text-white placeholder-gray-500 focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-transparent w-56"
                  />
                </div>
                <button
                  type="submit"
                  className="bg-green-600 hover:bg-green-700 transition-colors text-white rounded-r-full py-2 px-4 text-sm font-medium border border-green-600"
                >
                  Subscribe
                </button>
              </form>
          ...
          <div className="border-t border-gray-800/50 mt-6 pt-8 flex flex-col md:flex-row justify-between items-center text-gray-500 text-sm">
            <p>© 2025 JavaBank. All rights reserved.</p>
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-2 mt-4 md:mt-0 justify-center">
              ...
              <div className="flex items-center">
                <span className="inline-flex items-center px-2 py-1 bg-gradient-to-r from-green-900/30 to-emerald-900/30 rounded-full text-xs font-medium text-green-400 mr-2">
