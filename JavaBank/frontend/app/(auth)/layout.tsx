...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-green-700 via-emerald-700 to-amber-500 text-white relative overflow-hidden">
        {/* Background shapes */}
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-0 left-0 w-64 h-64 bg-emerald-500 rounded-full filter blur-3xl -translate-x-1/2 -translate-y-1/2"></div>
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-amber-500 rounded-full filter blur-3xl translate-x-1/4 translate-y-1/4"></div>
        </div>
        ...
        <div className="w-full h-full flex flex-col justify-center items-center p-12 relative z-10">
          <div className="max-w-xl text-center">
            ...
            <h1 className="text-4xl font-bold mb-6">Welcome to JavaBank</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-12">
              <div className="p-5 rounded-xl bg-white/10 backdrop-blur-sm border border-white/5 flex flex-col items-center justify-center">
                <div className="h-10 w-10 rounded-full bg-emerald-600/30 flex items-center justify-center mb-3">
              ...
              <div className="p-5 rounded-xl bg-white/10 backdrop-blur-sm border border-white/5 flex flex-col items-center justify-center">
                <div className="h-10 w-10 rounded-full bg-amber-500/30 flex items-center justify-center mb-3">
      ...
      {/* Form Area */}
      <div className="w-full md:w-1/2 bg-gradient-to-b from-gray-50 to-white flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <div className="md:hidden flex items-center justify-center mb-8">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-700 to-amber-500">
                JavaBank
              </span>
            </Link>
          </div>
