      ...
      <div className="flex items-center justify-between px-4 lg:px-6 h-16">
        ...
        <div className="hidden md:flex items-center gap-3">
          ...
          <div className="flex items-center bg-gray-100 rounded-lg p-0.5">
            <button
              onClick={() => dispatch(setDeploymentMode('cloud'))}
              className={`flex cursor-pointer items-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-all duration-200 ${
            ...
            <button
              onClick={() => dispatch(setDeploymentMode('on-prem'))}
              className={`flex items-center cursor-pointer gap-1.5 px-3 py-1.5 rounded-md text-xs font-medium transition-all duration-200 ${
        ...
        <div className="flex items-center gap-4">
          ...
          <div ref={profileRef} className="relative">
            <button
              ...
              className="w-8 h-8 cursor-pointer rounded-full bg-[#1a73e8] flex items-center justify-center text-white text-[13px] font-medium hover:bg-blue-700 transition-colors duration-200"
              id="profile-btn"
            >
              AK
            </button>
            {showProfileDropdown && (
              <div className="absolute cursor-pointer right-0 mt-2 w-56 bg-white border border-gray-200 rounded-lg shadow-lg py-2 z-50 animate-in fade-in slide-in-from-top-2 duration-150 text-left">
                <div className="px-4 py-3 cursor-pointer border-b border-gray-100">
                  <p className="text-sm font-medium text-gray-900">Abhishek Kumawat</p>
                  <p className="text-xs text-gray-500 truncate">abhishek@nucleus.com</p>
                </div>
                <div className="py-1">
                ...
                <div className="border-t cursor-pointer border-gray-100 py-1">
                  <button className="w-full cursor-pointer text-left px-4 py-2 text-sm text-red-600 hover:bg-gray-50">Sign Out</button>
                </div>
              </div>
            )}
          </div>
